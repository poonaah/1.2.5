...
public class RenderBlocks
{
    ...
    public boolean renderBlockVine(Block par1Block, int par2, int par3, int par4)
    {
        ...
        float f = 1.0F;
        tessellator.setBrightness(par1Block.getMixedBrightnessForBlock(blockAccess, par2, par3, par4));
        int j = CustomColorizer.getColorMultiplier(par1Block, blockAccess, par2, par3, par4);
    ...
    public boolean renderBlockPane(BlockPane par1BlockPane, int par2, int par3, int par4)
    {
        ...
        Tessellator tessellator = Tessellator.instance;
        boolean flag = par1BlockPane == Block.thinGlass && Config.isConnectedTextures();
    ...
    public boolean renderBlockLilyPad(Block par1Block, int par2, int par3, int par4)
    {
        ...
        tessellator.setColorOpaque_I(j1);
        ...
        tessellator.setColorOpaque_I((j1 & 0xfefefe) >> 1);
        tessellator.addVertexWithUV(f1 - f3 - f4, (float)par3 + f, (f2 + f3) - f4, d, d3);
        tessellator.addVertexWithUV((f1 - f3) + f4, (float)par3 + f, f2 - f3 - f4, d1, d3);
        tessellator.addVertexWithUV(f1 + f3 + f4, (float)par3 + f, (f2 - f3) + f4, d1, d2);
        tessellator.addVertexWithUV((f1 + f3) - f4, (float)par3 + f, f2 + f3 + f4, d, d2);
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3 - 1, par4, 0))
        {
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag2 ? par5 : 1.0F) * 0.5F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag2 ? par6 : 1.0F) * 0.5F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag2 ? par7 : 1.0F) * 0.5F;
            colorRedTopLeft *= f;
            colorGreenTopLeft *= f;
            colorBlueTopLeft *= f;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3 + 1, par4, 1))
        {
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = flag3 ? par5 : 1.0F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = flag3 ? par6 : 1.0F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = flag3 ? par7 : 1.0F;
            colorRedTopLeft *= f1;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            if (Tessellator.instance.defaultTexture && fancyGrass && l1 == 3 && overrideBlockTexture < 0)
            {
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            if (Tessellator.instance.defaultTexture && fancyGrass && i2 == 3 && overrideBlockTexture < 0)
            {
                colorRedTopLeft *= par5;
                colorRedBottomLeft *= par5;
                colorRedBottomRight *= par5;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            if (Tessellator.instance.defaultTexture && fancyGrass && j2 == 3 && overrideBlockTexture < 0)
            {
                colorRedTopLeft *= par5;
                colorRedBottomLeft *= par5;
                colorRedBottomRight *= par5;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            if (Tessellator.instance.defaultTexture && fancyGrass && k2 == 3 && overrideBlockTexture < 0)
            {
                colorRedTopLeft *= par5;
                colorRedBottomLeft *= par5;
                colorRedBottomRight *= par5;
    ...
    {
        if (!Tessellator.instance.defaultTexture)
        {
            return i;
        }
        ...
        if (i == 3)
        {
            i = Config.getSideGrassTexture(blockAccess, j, k, l, i1);
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            if (flag)
            {
                if (j == 3)
                {
                    j = Config.getSideGrassTexture(blockAccess, par2, par3, par4, 2);
            ...
            if ((Tessellator.instance.defaultTexture && fancyGrass || Config.isBetterGrass()) && j == 3 && overrideBlockTexture < 0)
            {
                tessellator.setColorOpaque_F(f8 * par5, f11 * par6, f14 * par7);
                renderEastFace(par1Block, par2, par3, par4, 38);
            }
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            if (flag)
            {
                if (k == 3)
                {
                    k = Config.getSideGrassTexture(blockAccess, par2, par3, par4, 3);
            ...
            if ((Tessellator.instance.defaultTexture && fancyGrass || Config.isBetterGrass()) && k == 3 && overrideBlockTexture < 0)
            {
                tessellator.setColorOpaque_F(f8 * par5, f11 * par6, f14 * par7);
                renderWestFace(par1Block, par2, par3, par4, 38);
            }
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            if (flag)
            {
                if (l == 3)
                {
                    l = Config.getSideGrassTexture(blockAccess, par2, par3, par4, 4);
            ...
            if ((Tessellator.instance.defaultTexture && fancyGrass || Config.isBetterGrass()) && l == 3 && overrideBlockTexture < 0)
            {
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            if (flag)
            {
                if (i1 == 3)
                {
                    i1 = Config.getSideGrassTexture(blockAccess, par2, par3, par4, 5);
            ...
            if ((Tessellator.instance.defaultTexture && fancyGrass || Config.isBetterGrass()) && i1 == 3 && overrideBlockTexture < 0)
            {
                tessellator.setColorOpaque_F(f9 * par5, f12 * par6, f15 * par7);
                renderSouthFace(par1Block, par2, par3, par4, 38);
            }
    ...
    public void renderBottomFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        {
            int i = getConnectedTexture(par1Block, (int)par2, (int)par4, (int)par6, 0);

            if (i >= 0)
            {
                int k = Config.getMinecraft().renderEngine.getTexture("/ctm.png");
    ...
    public void renderTopFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isConnectedTextures() && overrideBlockTexture < 0)
        {
            int i = getConnectedTexture(par1Block, (int)par2, (int)par4, (int)par6, 1);
    ...
    public void renderEastFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isConnectedTextures() && overrideBlockTexture < 0)
        {
            int i = getConnectedTexture(par1Block, (int)par2, (int)par4, (int)par6, 2);
    ...
    public void renderWestFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isConnectedTextures() && overrideBlockTexture < 0)
        {
            int i = getConnectedTexture(par1Block, (int)par2, (int)par4, (int)par6, 3);
    ...
    public void renderNorthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isConnectedTextures() && overrideBlockTexture < 0)
        {
            int i = getConnectedTexture(par1Block, (int)par2, (int)par4, (int)par6, 4);
    ...
    public void renderSouthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isConnectedTextures() && overrideBlockTexture < 0)
        {
            int i = getConnectedTexture(par1Block, (int)par2, (int)par4, (int)par6, 5);
    ...
    private int getConnectedGlassTexture(Block block, int i, int j, int k, int l)
    {
        ...
        int i1 = Block.glass.blockID;

        switch (l)
        {
            case 0:
            case 1:
                aflag[0] = isNeighbour(blockAccess, i - 1, j, k, i1);
                aflag[1] = isNeighbour(blockAccess, i + 1, j, k, i1);
                aflag[2] = isNeighbour(blockAccess, i, j, k + 1, i1);
                aflag[3] = isNeighbour(blockAccess, i, j, k - 1, i1);
                break;

            case 2:
                aflag[0] = isNeighbour(blockAccess, i + 1, j, k, i1);
                aflag[1] = isNeighbour(blockAccess, i - 1, j, k, i1);
                aflag[2] = isNeighbour(blockAccess, i, j - 1, k, i1);
                aflag[3] = isNeighbour(blockAccess, i, j + 1, k, i1);
                break;
            ...
            case 4:
                aflag[0] = isNeighbour(blockAccess, i, j, k - 1, i1);
                aflag[1] = isNeighbour(blockAccess, i, j, k + 1, i1);
                aflag[2] = isNeighbour(blockAccess, i, j - 1, k, i1);
                aflag[3] = isNeighbour(blockAccess, i, j + 1, k, i1);
                break;
        ...
        switch (l)
        {
            case 0:
            case 1:
                aflag1[0] = !isNeighbour(blockAccess, i + 1, j, k + 1, i1);
                aflag1[1] = !isNeighbour(blockAccess, i - 1, j, k + 1, i1);
                aflag1[2] = !isNeighbour(blockAccess, i + 1, j, k - 1, i1);
                aflag1[3] = !isNeighbour(blockAccess, i - 1, j, k - 1, i1);
                break;

            case 2:
                aflag1[0] = !isNeighbour(blockAccess, i - 1, j - 1, k, i1);
                aflag1[1] = !isNeighbour(blockAccess, i + 1, j - 1, k, i1);
                aflag1[2] = !isNeighbour(blockAccess, i - 1, j + 1, k, i1);
                aflag1[3] = !isNeighbour(blockAccess, i + 1, j + 1, k, i1);
                break;
            ...
            case 4:
                aflag1[0] = !isNeighbour(blockAccess, i, j - 1, k + 1, i1);
                aflag1[1] = !isNeighbour(blockAccess, i, j - 1, k - 1, i1);
                aflag1[2] = !isNeighbour(blockAccess, i, j + 1, k + 1, i1);
                aflag1[3] = !isNeighbour(blockAccess, i, j + 1, k - 1, i1);
                break;
    ...
    {
        return iblockaccess.getBlockId(i, j, k) == l;
    }
    ...
    private int getConnectedBookShelfTexture(Block block, int i, int j, int k, int l)
    {
        ...
        boolean flag = false;
        boolean flag1 = false;
        int i1 = Block.bookShelf.blockID;

        switch (l)
        {
            case 2:
                flag = isNeighbour(blockAccess, i + 1, j, k, i1);
                flag1 = isNeighbour(blockAccess, i - 1, j, k, i1);
                break;
            ...
            case 4:
                flag = isNeighbour(blockAccess, i, j, k - 1, i1);
                flag1 = isNeighbour(blockAccess, i, j, k + 1, i1);
                break;
    ...
    private int getConnectedSandStoneTexture(Block block, int i, int j, int k, int l)
    {
        ...
        return !isNeighbour(blockAccess, i, j + 1, k, Block.sandStone.blockID) ? 65 : 66;
    }
