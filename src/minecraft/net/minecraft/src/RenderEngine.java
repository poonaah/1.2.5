        ...
        for (int j = 0; j < textureList.size(); j++)
        {
            ...
            do
            {
                ...
                for (int l1 = 0; l1 < texturefx.tileSize; l1++)
                {
                    ...
                    GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, 0, i2, j2, l, i1, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, imageData);
                    ...
                    if (k1 == 0 && l1 == 0)
                    {
                        generateMipMapsSub(i2, j2, l, i1, imageData, texturefx.tileSize, flag3, s);
                    }
                }
