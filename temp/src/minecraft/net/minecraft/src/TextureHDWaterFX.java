...
public class TextureHDWaterFX extends TextureFX
    implements TextureHDFX
{
    ...
    public void func_783_a()
    {
        ...
        for(int j1 = 0; j1 < tileWidth * tileWidth; j1++)
        {
            ...
            field_1127_a[j1 * 4 + 0] = (byte)i2;
            field_1127_a[j1 * 4 + 1] = (byte)k2;
            field_1127_a[j1 * 4 + 2] = (byte)l2;
            field_1127_a[j1 * 4 + 3] = (byte)i3;
        }
