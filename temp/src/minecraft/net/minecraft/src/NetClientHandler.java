...
//            TileEntityBrewingStand, Packet103SetSlot, Slot, Packet106Transaction, 
//            Packet104WindowItems, Packet130UpdateSign, TileEntitySign, Packet132TileEntityData, 
//            TileEntityMobSpawner, Packet105UpdateProgressbar, Packet5PlayerInventory, Packet54PlayNoteBlock, 
//            Packet70Bed, GuiWinGame, Packet131MapData, Item, 
...
//            PlayerCapabilities, Packet, Packet101CloseWindow, Packet250CustomPayload
...
public class NetClientHandler extends NetHandler
{
    ...
    public void func_4115_a(Packet1Login p_4115_1_)
    {
        ...
        ModLoader.serverConnect(this, p_4115_1_);
    }
    ...
    public void func_20088_a(Packet103SetSlot p_20088_1_)
    {
        ...
        {
            entityplayersp.field_778_b.func_20076_b(p_20088_1_.field_20043_c);
        } else
        if(p_20088_1_.field_20042_a == 0 && p_20088_1_.field_20041_b >= 36 && p_20088_1_.field_20041_b < 45)
        {
            ItemStack itemstack = entityplayersp.field_20069_g.func_20118_a(p_20088_1_.field_20041_b).func_777_b();
            ...
            entityplayersp.field_20069_g.func_20119_a(p_20088_1_.field_20041_b, p_20088_1_.field_20043_c);
        } else
        if(p_20088_1_.field_20042_a == entityplayersp.field_20068_h.field_1618_c)
        {
            entityplayersp.field_20068_h.func_20119_a(p_20088_1_.field_20041_b, p_20088_1_.field_20043_c);
        }
    }
    ...
    public void func_20089_a(Packet106Transaction p_20089_1_)
    {
        ...
        {
            container = entityplayersp.field_20069_g;
        } else
        if(p_20089_1_.field_20029_a == entityplayersp.field_20068_h.field_1618_c)
        {
            container = entityplayersp.field_20068_h;
        }
        if(container != null)
        {
    ...
    public void func_20094_a(Packet104WindowItems p_20094_1_)
    {
        ...
        {
            entityplayersp.field_20069_g.func_20115_a(p_20094_1_.field_20035_b);
        } else
        if(p_20094_1_.field_20036_a == entityplayersp.field_20068_h.field_1618_c)
        {
            entityplayersp.field_20068_h.func_20115_a(p_20094_1_.field_20035_b);
        }
    }
    ...
    public void func_20090_a(Packet105UpdateProgressbar p_20090_1_)
    {
        ...
        if(entityplayersp.field_20068_h != null && entityplayersp.field_20068_h.field_1618_c == p_20090_1_.field_20032_a)
        {
            entityplayersp.field_20068_h.func_20112_a(p_20090_1_.field_20031_b, p_20090_1_.field_20033_c);
        }
    }
    ...
    {
        EntityPlayerSP entityplayersp = field_1212_e.field_6322_g;
        entityplayersp.field_35212_aW.field_35757_b = p_50100_1_.field_50070_b;
        entityplayersp.field_35212_aW.field_35756_d = p_50100_1_.field_50069_d;
        entityplayersp.field_35212_aW.field_35759_a = p_50100_1_.field_50072_a;
        entityplayersp.field_35212_aW.field_35758_c = p_50100_1_.field_50071_c;
    }
