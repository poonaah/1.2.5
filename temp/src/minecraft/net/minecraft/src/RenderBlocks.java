...
//            Config, Block, BlockRail, BlockDragonEgg, 
//            BlockFence, BlockPane, BlockFenceGate, BlockCauldron, 
//            BlockBrewingStand, Reflector, IBlockAccess, BlockEndPortalFrame, 
//            Tessellator, BlockBed, Direction, EntityRenderer, 
//            CustomColorizer, BlockRedstoneRepeater, BlockPistonBase, BlockPistonExtension, 
//            Vec3D, BlockFire, BlockRedstoneWire, RenderEngine, 
//            BlockStem, BlockFluid, MathHelper, Material, 
//            BlockGlass, BlockDirectional, BlockDoor, BlockGrass, 
//            ChestItemRenderHelper, World
...
public class RenderBlocks
{
    ...
    public boolean func_1234_a(Block p_1234_1_, int p_1234_2_, int p_1234_3_, int p_1234_4_)
    {
        ...
        if(Config.isBetterSnow() && p_1234_1_ == Block.field_443_aE && hasSnowNeighbours(p_1234_2_, p_1234_3_, p_1234_4_))
        {
            func_1228_k(Block.field_428_aT, p_1234_2_, p_1234_3_, p_1234_4_);
        }
        if(i == 0)
        {
        ...
        if(Reflector.hasClass(0))
        {
            return Reflector.callBoolean(0, new Object[] {
                this, field_1772_a, Integer.valueOf(p_1234_2_), Integer.valueOf(p_1234_3_), Integer.valueOf(p_1234_4_), p_1234_1_, Integer.valueOf(i)
            });
        } else
        {
            return false;
    ...
    {
        int l = Block.field_428_aT.field_376_bc;
        if(field_1772_a.func_600_a(i - 1, j, k) == l || field_1772_a.func_600_a(i + 1, j, k) == l || field_1772_a.func_600_a(i, j, k - 1) == l || field_1772_a.func_600_a(i, j, k + 1) == l)
        {
            return field_1772_a.func_601_g(i, j - 1, k);
        } else
        {
            return false;
        }
    ...
    public boolean func_22331_p(Block p_22331_1_, int p_22331_2_, int p_22331_3_, int p_22331_4_)
    {
        ...
        {
            tessellator.func_35835_b(p_22331_1_.field_366_bh > 0.0D ? k : p_22331_1_.func_35275_c(field_1772_a, p_22331_2_, p_22331_3_, p_22331_4_ - 1));
        ...
        {
            tessellator.func_35835_b(p_22331_1_.field_360_bk < 1.0D ? k : p_22331_1_.func_35275_c(field_1772_a, p_22331_2_, p_22331_3_, p_22331_4_ + 1));
            tessellator.func_987_a(f8, f11, f14);
            field_1774_c = i1 == 3;
        ...
        {
            tessellator.func_35835_b(p_22331_1_.field_366_bh > 0.0D ? k : p_22331_1_.func_35275_c(field_1772_a, p_22331_2_ - 1, p_22331_3_, p_22331_4_));
        ...
        {
            tessellator.func_35835_b(p_22331_1_.field_360_bk < 1.0D ? k : p_22331_1_.func_35275_c(field_1772_a, p_22331_2_ + 1, p_22331_3_, p_22331_4_));
            tessellator.func_987_a(f9, f12, f15);
            field_1774_c = i1 == 5;
    ...
    public boolean func_40728_a(BlockCauldron p_40728_1_, int p_40728_2_, int p_40728_3_, int p_40728_4_)
    {
        ...
        if(j > 0)
        {
            ...
            int k = CustomColorizer.getFluidColor(Block.field_399_C, field_1772_a, p_40728_2_, p_40728_3_, p_40728_4_);
            float f8 = (float)(k >> 16 & 0xff) / 255F;
            float f9 = (float)(k >> 8 & 0xff) / 255F;
            float f10 = (float)(k & 0xff) / 255F;
            tessellator.func_987_a(f8, f9, f10);
    ...
    public boolean func_1241_b(Block p_1241_1_, int p_1241_2_, int p_1241_3_, int p_1241_4_)
    {
        ...
        } else
        {
            ...
            Block _tmp = p_1241_1_;
            if(p_1241_1_ != Block.field_404_ar && Config.isBetterSnow() && hasSnowNeighbours(p_1241_2_, p_1241_3_, p_1241_4_))
            {
                func_1228_k(Block.field_428_aT, p_1241_2_, p_1241_3_, p_1241_4_);
            }
        }
        return true;
    }
    ...
    public boolean func_1229_c(Block p_1229_1_, int p_1229_2_, int p_1229_3_, int p_1229_4_)
    {
        ...
        if(Config.isBetterSnow() && hasSnowNeighbours(p_1229_2_, p_1229_3_, p_1229_4_))
        {
            func_1228_k(Block.field_428_aT, p_1229_2_, p_1229_3_, p_1229_4_);
        }
        return true;
    }
    ...
    public boolean func_1235_d(Block p_1235_1_, int p_1235_2_, int p_1235_3_, int p_1235_4_)
    {
        ...
        {
            double d4 = (double)p_1235_2_ + 0.5D + 0.20000000000000001D;
            double d5 = ((double)p_1235_2_ + 0.5D) - 0.20000000000000001D;
            ...
            tessellator.func_983_a(d4, p_1235_3_ + 0, p_1235_4_ + 0, d, d3);
        ...
        } else
        {
            ...
            if(Block.field_402_as.func_261_b(field_1772_a, p_1235_2_, p_1235_3_ + 1, p_1235_4_))
            {
                ...
                double d9 = ((double)p_1235_2_ + 0.5D) - 0.5D;
                double d11 = (double)p_1235_4_ + 0.5D + 0.5D;
                double d13 = ((double)p_1235_4_ + 0.5D) - 0.5D;
                double d15 = ((double)p_1235_2_ + 0.5D) - 0.5D;
                double d17 = (double)p_1235_2_ + 0.5D + 0.5D;
                double d19 = ((double)p_1235_4_ + 0.5D) - 0.5D;
                ...
                {
                    tessellator.func_983_a(d15, (float)p_1235_3_ + f3, p_1235_4_ + 0, d22, d23);
                    tessellator.func_983_a(d7, p_1235_3_ + 0, p_1235_4_ + 0, d22, d24);
                    tessellator.func_983_a(d7, p_1235_3_ + 0, p_1235_4_ + 1, d21, d24);
                    tessellator.func_983_a(d15, (float)p_1235_3_ + f3, p_1235_4_ + 1, d21, d23);
                    d21 = (float)j / 256F;
                    d22 = ((float)j + 15.99F) / 256F;
                    d23 = (float)(k + 16) / 256F;
                    d24 = ((float)k + 15.99F + 16F) / 256F;
                    tessellator.func_983_a(d17, (float)p_1235_3_ + f3, p_1235_4_ + 1, d22, d23);
                    tessellator.func_983_a(d9, p_1235_3_ + 0, p_1235_4_ + 1, d22, d24);
                    tessellator.func_983_a(d9, p_1235_3_ + 0, p_1235_4_ + 0, d21, d24);
                    tessellator.func_983_a(d17, (float)p_1235_3_ + f3, p_1235_4_ + 0, d21, d23);
                } else
                {
                    tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f3, d20, d22, d23);
                    tessellator.func_983_a(p_1235_2_ + 0, p_1235_3_ + 0, d13, d22, d24);
                    tessellator.func_983_a(p_1235_2_ + 1, p_1235_3_ + 0, d13, d21, d24);
                    tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f3, d20, d21, d23);
                    d21 = (float)j / 256F;
                    d22 = ((float)j + 15.99F) / 256F;
                    d23 = (float)(k + 16) / 256F;
                    d24 = ((float)k + 15.99F + 16F) / 256F;
                    tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f3, d19, d22, d23);
                    tessellator.func_983_a(p_1235_2_ + 1, p_1235_3_ + 0, d11, d22, d24);
                    tessellator.func_983_a(p_1235_2_ + 0, p_1235_3_ + 0, d11, d21, d24);
                    tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f3, d19, d21, d23);
                }
            }
        }
        return true;
    ...
    public boolean func_1242_e(Block p_1242_1_, int p_1242_2_, int p_1242_3_, int p_1242_4_)
    {
        ...
        if(byte0 == 0)
        {
            ...
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f8, d1, d3);
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f7, d1, d2);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f7, d, d2);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f8, d, d3);
            tessellator.func_987_a(f, f, f);
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f8, d1, d3 + 0.0625D);
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f7, d1, d2 + 0.0625D);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f7, d, d2 + 0.0625D);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f8, d, d3 + 0.0625D);
        } else
        if(byte0 == 1)
        {
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f8, d1, d3);
        ...
        {
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f8, d1, d3);
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f7, d, d3);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f7, d, d2);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f8, d1, d2);
            tessellator.func_987_a(f, f, f);
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f8, d1, d3 + 0.0625D);
            tessellator.func_983_a(f6, (double)p_1242_3_ + 0.015625D, f7, d, d3 + 0.0625D);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f7, d, d2 + 0.0625D);
            tessellator.func_983_a(f5, (double)p_1242_3_ + 0.015625D, f8, d1, d2 + 0.0625D);
        }
        if(!field_1772_a.func_28100_h(p_1242_2_, p_1242_3_ + 1, p_1242_4_))
        {
            ...
            if(field_1772_a.func_28100_h(p_1242_2_ - 1, p_1242_3_, p_1242_4_) && field_1772_a.func_600_a(p_1242_2_ - 1, p_1242_3_ + 1, p_1242_4_) == Block.field_394_aw.field_376_bc)
            {
                ...
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 1, d6, d7);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, p_1242_3_ + 0, p_1242_4_ + 1, d4, d7);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, p_1242_3_ + 0, p_1242_4_ + 0, d4, d8);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 0, d6, d8);
                tessellator.func_987_a(f, f, f);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 1, d6, d7 + 0.0625D);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, p_1242_3_ + 0, p_1242_4_ + 1, d4, d7 + 0.0625D);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, p_1242_3_ + 0, p_1242_4_ + 0, d4, d8 + 0.0625D);
                tessellator.func_983_a((double)p_1242_2_ + 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 0, d6, d8 + 0.0625D);
            }
            if(field_1772_a.func_28100_h(p_1242_2_ + 1, p_1242_3_, p_1242_4_) && field_1772_a.func_600_a(p_1242_2_ + 1, p_1242_3_ + 1, p_1242_4_) == Block.field_394_aw.field_376_bc)
            {
                tessellator.func_987_a(f * f2, f * f3, f * f4);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, p_1242_3_ + 0, p_1242_4_ + 1, d4, d8);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 1, d6, d8);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 0, d6, d7);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, p_1242_3_ + 0, p_1242_4_ + 0, d4, d7);
                tessellator.func_987_a(f, f, f);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, p_1242_3_ + 0, p_1242_4_ + 1, d4, d8 + 0.0625D);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 1, d6, d8 + 0.0625D);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, (float)(p_1242_3_ + 1) + 0.021875F, p_1242_4_ + 0, d6, d7 + 0.0625D);
                tessellator.func_983_a((double)(p_1242_2_ + 1) - 0.015625D, p_1242_3_ + 0, p_1242_4_ + 0, d4, d7 + 0.0625D);
            }
            ...
            {
                tessellator.func_987_a(f * f2, f * f3, f * f4);
                tessellator.func_983_a(p_1242_2_ + 1, p_1242_3_ + 0, (double)p_1242_4_ + 0.015625D, d4, d8);
                tessellator.func_983_a(p_1242_2_ + 1, (float)(p_1242_3_ + 1) + 0.021875F, (double)p_1242_4_ + 0.015625D, d6, d8);
                tessellator.func_983_a(p_1242_2_ + 0, (float)(p_1242_3_ + 1) + 0.021875F, (double)p_1242_4_ + 0.015625D, d6, d7);
                tessellator.func_983_a(p_1242_2_ + 0, p_1242_3_ + 0, (double)p_1242_4_ + 0.015625D, d4, d7);
                tessellator.func_987_a(f, f, f);
                tessellator.func_983_a(p_1242_2_ + 1, p_1242_3_ + 0, (double)p_1242_4_ + 0.015625D, d4, d8 + 0.0625D);
                tessellator.func_983_a(p_1242_2_ + 1, (float)(p_1242_3_ + 1) + 0.021875F, (double)p_1242_4_ + 0.015625D, d6, d8 + 0.0625D);
                tessellator.func_983_a(p_1242_2_ + 0, (float)(p_1242_3_ + 1) + 0.021875F, (double)p_1242_4_ + 0.015625D, d6, d7 + 0.0625D);
                tessellator.func_983_a(p_1242_2_ + 0, p_1242_3_ + 0, (double)p_1242_4_ + 0.015625D, d4, d7 + 0.0625D);
            }
            if(field_1772_a.func_28100_h(p_1242_2_, p_1242_3_, p_1242_4_ + 1) && field_1772_a.func_600_a(p_1242_2_, p_1242_3_ + 1, p_1242_4_ + 1) == Block.field_394_aw.field_376_bc)
            {
                tessellator.func_987_a(f * f2, f * f3, f * f4);
                tessellator.func_983_a(p_1242_2_ + 1, (float)(p_1242_3_ + 1) + 0.021875F, (double)(p_1242_4_ + 1) - 0.015625D, d6, d7);
                tessellator.func_983_a(p_1242_2_ + 1, p_1242_3_ + 0, (double)(p_1242_4_ + 1) - 0.015625D, d4, d7);
                tessellator.func_983_a(p_1242_2_ + 0, p_1242_3_ + 0, (double)(p_1242_4_ + 1) - 0.015625D, d4, d8);
                tessellator.func_983_a(p_1242_2_ + 0, (float)(p_1242_3_ + 1) + 0.021875F, (double)(p_1242_4_ + 1) - 0.015625D, d6, d8);
                tessellator.func_987_a(f, f, f);
                tessellator.func_983_a(p_1242_2_ + 1, (float)(p_1242_3_ + 1) + 0.021875F, (double)(p_1242_4_ + 1) - 0.015625D, d6, d7 + 0.0625D);
                tessellator.func_983_a(p_1242_2_ + 1, p_1242_3_ + 0, (double)(p_1242_4_ + 1) - 0.015625D, d4, d7 + 0.0625D);
                tessellator.func_983_a(p_1242_2_ + 0, p_1242_3_ + 0, (double)(p_1242_4_ + 1) - 0.015625D, d4, d8 + 0.0625D);
                tessellator.func_983_a(p_1242_2_ + 0, (float)(p_1242_3_ + 1) + 0.021875F, (double)(p_1242_4_ + 1) - 0.015625D, d6, d8 + 0.0625D);
            }
        }
        if(Config.isBetterSnow() && hasSnowNeighbours(p_1242_2_, p_1242_3_, p_1242_4_))
        {
            double d5 = Block.field_428_aT.field_362_bj;
            Block.field_428_aT.field_362_bj = 0.01D;
            func_1228_k(Block.field_428_aT, p_1242_2_, p_1242_3_, p_1242_4_);
            Block.field_428_aT.field_362_bj = d5;
        }
        return true;
    }
    ...
    public boolean func_1216_f(BlockRail p_1216_1_, int p_1216_2_, int p_1216_3_, int p_1216_4_)
    {
        ...
        tessellator.func_983_a(d6, d14, d10, d1, d3);
        tessellator.func_983_a(d5, d13, d9, d1, d2);
        if(Config.isBetterSnow() && hasSnowNeighbours(p_1216_2_, p_1216_3_, p_1216_4_))
        {
            double d17 = Block.field_428_aT.field_362_bj;
            Block.field_428_aT.field_362_bj = 0.050000000000000003D;
            func_1228_k(Block.field_428_aT, p_1216_2_, p_1216_3_, p_1216_4_);
            Block.field_428_aT.field_362_bj = d17;
        }
        return true;
    }
    ...
    public boolean func_35929_i(Block p_35929_1_, int p_35929_2_, int p_35929_3_, int p_35929_4_)
    {
        ...
        int j = CustomColorizer.getColorMultiplier(p_35929_1_, field_1772_a, p_35929_2_, p_35929_3_, p_35929_4_);
        ...
        if((k & 2) != 0)
        {
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 1, p_35929_4_ + 1, f2, d1);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 0, p_35929_4_ + 1, f2, d2);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 0, p_35929_4_ + 0, d, d2);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 1, p_35929_4_ + 0, d, d1);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 1, p_35929_4_ + 0, d, d1);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 0, p_35929_4_ + 0, d, d2);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 0, p_35929_4_ + 1, f2, d2);
            tessellator.func_983_a((double)p_35929_2_ + d3, p_35929_3_ + 1, p_35929_4_ + 1, f2, d1);
        ...
        if((k & 8) != 0)
        {
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 0, p_35929_4_ + 1, d, d2);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 1, p_35929_4_ + 1, d, d1);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 1, p_35929_4_ + 0, f2, d1);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 0, p_35929_4_ + 0, f2, d2);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 0, p_35929_4_ + 0, f2, d2);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 1, p_35929_4_ + 0, f2, d1);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 1, p_35929_4_ + 1, d, d1);
            tessellator.func_983_a((double)(p_35929_2_ + 1) - d3, p_35929_3_ + 0, p_35929_4_ + 1, d, d2);
        ...
        if((k & 4) != 0)
        {
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 0, (double)p_35929_4_ + d3, d, d2);
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 1, (double)p_35929_4_ + d3, d, d1);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 1, (double)p_35929_4_ + d3, f2, d1);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 0, (double)p_35929_4_ + d3, f2, d2);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 0, (double)p_35929_4_ + d3, f2, d2);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 1, (double)p_35929_4_ + d3, f2, d1);
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 1, (double)p_35929_4_ + d3, d, d1);
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 0, (double)p_35929_4_ + d3, d, d2);
        ...
        if((k & 1) != 0)
        {
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 1, (double)(p_35929_4_ + 1) - d3, f2, d1);
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 0, (double)(p_35929_4_ + 1) - d3, f2, d2);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 0, (double)(p_35929_4_ + 1) - d3, d, d2);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 1, (double)(p_35929_4_ + 1) - d3, d, d1);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 1, (double)(p_35929_4_ + 1) - d3, d, d1);
            tessellator.func_983_a(p_35929_2_ + 0, p_35929_3_ + 0, (double)(p_35929_4_ + 1) - d3, d, d2);
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 0, (double)(p_35929_4_ + 1) - d3, f2, d2);
            tessellator.func_983_a(p_35929_2_ + 1, p_35929_3_ + 1, (double)(p_35929_4_ + 1) - d3, f2, d1);
        ...
        {
            tessellator.func_983_a(p_35929_2_ + 1, (double)(p_35929_3_ + 1) - d3, p_35929_4_ + 0, f2, d1);
            tessellator.func_983_a(p_35929_2_ + 1, (double)(p_35929_3_ + 1) - d3, p_35929_4_ + 1, f2, d2);
            tessellator.func_983_a(p_35929_2_ + 0, (double)(p_35929_3_ + 1) - d3, p_35929_4_ + 1, d, d2);
            tessellator.func_983_a(p_35929_2_ + 0, (double)(p_35929_3_ + 1) - d3, p_35929_4_ + 0, d, d1);
        }
        return true;
    }
    ...
    public boolean func_35922_a(BlockPane p_35922_1_, int p_35922_2_, int p_35922_3_, int p_35922_4_)
    {
        ...
        Tessellator tessellator = Tessellator.field_1512_a;
        boolean flag = p_35922_1_ == Block.field_35282_br && Config.isConnectedTextures();
        ...
        } else
        {
            ...
            if(flag)
            {
                int k1 = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator7 = Tessellator.field_1512_a.getSubTessellator(k1);
                k = 0;
            }
        }
        int j1 = k;
        int l1 = k;
        int i2 = k;
        int j2 = field_1772_a.func_600_a(p_35922_2_ + 1, p_35922_3_, p_35922_4_);
        int k2 = field_1772_a.func_600_a(p_35922_2_ - 1, p_35922_3_, p_35922_4_);
        int l2 = field_1772_a.func_600_a(p_35922_2_, p_35922_3_, p_35922_4_ + 1);
        int i3 = field_1772_a.func_600_a(p_35922_2_, p_35922_3_, p_35922_4_ - 1);
        if(flag)
        {
            int j3 = Block.field_35282_br.field_376_bc;
            int l3 = field_1772_a.func_600_a(p_35922_2_, p_35922_3_ + 1, p_35922_4_);
            int j4 = field_1772_a.func_600_a(p_35922_2_, p_35922_3_ - 1, p_35922_4_);
            boolean flag1 = j2 == j3;
            boolean flag2 = k2 == j3;
            boolean flag3 = l3 == j3;
            boolean flag4 = j4 == j3;
        ...
        double d25 = p_35922_2_;
        double d26 = (double)p_35922_2_ + 0.5D;
        double d27 = p_35922_2_ + 1;
        double d28 = p_35922_4_;
        double d29 = (double)p_35922_4_ + 0.5D;
        double d30 = p_35922_4_ + 1;
        double d31 = ((double)p_35922_2_ + 0.5D) - 0.0625D;
        double d32 = (double)p_35922_2_ + 0.5D + 0.0625D;
        double d33 = ((double)p_35922_4_ + 0.5D) - 0.0625D;
        double d34 = (double)p_35922_4_ + 0.5D + 0.0625D;
        boolean flag7 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_, p_35922_3_, p_35922_4_ - 1));
        boolean flag8 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_, p_35922_3_, p_35922_4_ + 1));
        boolean flag9 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_ - 1, p_35922_3_, p_35922_4_));
        boolean flag10 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_ + 1, p_35922_3_, p_35922_4_));
        boolean flag11 = p_35922_1_.func_260_c(field_1772_a, p_35922_2_, p_35922_3_ + 1, p_35922_4_, 1);
        boolean flag12 = p_35922_1_.func_260_c(field_1772_a, p_35922_2_, p_35922_3_ - 1, p_35922_4_, 0);
        if(flag9 && flag10 || !flag9 && !flag10 && !flag7 && !flag8)
        {
            Tessellator tessellator1 = tessellator7;
            tessellator1.func_983_a(d25, p_35922_3_ + 1, d29, d, d3);
            tessellator1.func_983_a(d25, p_35922_3_ + 0, d29, d, d4);
            tessellator1.func_983_a(d27, p_35922_3_ + 0, d29, d2, d4);
            tessellator1.func_983_a(d27, p_35922_3_ + 1, d29, d2, d3);
            tessellator1.func_983_a(d27, p_35922_3_ + 1, d29, d5, d8);
            tessellator1.func_983_a(d27, p_35922_3_ + 0, d29, d5, d9);
            tessellator1.func_983_a(d25, p_35922_3_ + 0, d29, d7, d9);
            tessellator1.func_983_a(d25, p_35922_3_ + 1, d29, d7, d8);
            tessellator1 = tessellator8;
            if(flag11)
            {
                tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d24);
                tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d22);
                tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d22);
                tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d24);
                tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d24);
                tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d22);
                tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d22);
                tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d24);
            } else
            {
                if(p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_ - 1, p_35922_3_ + 1, p_35922_4_))
                {
                    tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d24);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d24);
                    tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d24);
                    tessellator1.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d24);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                }
                if(p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_ + 1, p_35922_3_ + 1, p_35922_4_))
                {
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d22);
                    tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d22);
                    tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d22);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                    tessellator1.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d22);
            ...
            if(flag12)
            {
                tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d34, d21, d24);
                tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d34, d21, d22);
                tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d33, d20, d22);
                tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d33, d20, d24);
                tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d34, d21, d24);
                tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d34, d21, d22);
                tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d33, d20, d22);
                tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d33, d20, d24);
            } else
            {
                if(p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_ - 1, p_35922_3_ - 1, p_35922_4_))
                {
                    tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d24);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d24);
                    tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d34, d21, d24);
                    tessellator1.func_983_a(d25, (double)p_35922_3_ - 0.01D, d33, d20, d24);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                }
                if(p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_ + 1, p_35922_3_ - 1, p_35922_4_))
                {
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d22);
                    tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d22);
                    tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d34, d21, d22);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                    tessellator1.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                    tessellator1.func_983_a(d27, (double)p_35922_3_ - 0.01D, d33, d20, d22);
        ...
        if(flag9 && !flag10)
        {
            ...
            tessellator2.func_983_a(d25, p_35922_3_ + 1, d29, d, d3);
            tessellator2.func_983_a(d25, p_35922_3_ + 0, d29, d, d4);
            tessellator2.func_983_a(d26, p_35922_3_ + 0, d29, d1, d4);
            tessellator2.func_983_a(d26, p_35922_3_ + 1, d29, d1, d3);
            tessellator2.func_983_a(d26, p_35922_3_ + 1, d29, d6, d8);
            tessellator2.func_983_a(d26, p_35922_3_ + 0, d29, d6, d9);
            tessellator2.func_983_a(d25, p_35922_3_ + 0, d29, d7, d9);
            tessellator2.func_983_a(d25, p_35922_3_ + 1, d29, d7, d8);
            tessellator2 = tessellator8;
            if(!flag8 && !flag7)
            {
                tessellator2.func_983_a(d26, p_35922_3_ + 1, d34, d20, d22);
                tessellator2.func_983_a(d26, p_35922_3_ + 0, d34, d20, d24);
                tessellator2.func_983_a(d26, p_35922_3_ + 0, d33, d21, d24);
                tessellator2.func_983_a(d26, p_35922_3_ + 1, d33, d21, d22);
                tessellator2.func_983_a(d26, p_35922_3_ + 1, d33, d20, d22);
                tessellator2.func_983_a(d26, p_35922_3_ + 0, d33, d20, d24);
                tessellator2.func_983_a(d26, p_35922_3_ + 0, d34, d21, d24);
                tessellator2.func_983_a(d26, p_35922_3_ + 1, d34, d21, d22);
            }
            if(flag11 || p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_ - 1, p_35922_3_ + 1, p_35922_4_))
            {
                tessellator2.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                tessellator2.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d24);
                tessellator2.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d24);
                tessellator2.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                tessellator2.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                tessellator2.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d24);
                tessellator2.func_983_a(d25, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d24);
                tessellator2.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
            }
            if(flag12 || p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_ - 1, p_35922_3_ - 1, p_35922_4_))
            {
                tessellator2.func_983_a(d25, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                tessellator2.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d24);
                tessellator2.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d24);
                tessellator2.func_983_a(d25, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                tessellator2.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                tessellator2.func_983_a(d25, (double)p_35922_3_ - 0.01D, d34, d21, d24);
                tessellator2.func_983_a(d25, (double)p_35922_3_ - 0.01D, d33, d20, d24);
                tessellator2.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d23);
            }
        } else
        if(!flag9 && flag10)
        {
            Tessellator tessellator3 = tessellator7;
            tessellator3.func_983_a(d26, p_35922_3_ + 1, d29, d1, d3);
            tessellator3.func_983_a(d26, p_35922_3_ + 0, d29, d1, d4);
            tessellator3.func_983_a(d27, p_35922_3_ + 0, d29, d2, d4);
            tessellator3.func_983_a(d27, p_35922_3_ + 1, d29, d2, d3);
            tessellator3.func_983_a(d27, p_35922_3_ + 1, d29, d5, d8);
            tessellator3.func_983_a(d27, p_35922_3_ + 0, d29, d5, d9);
            tessellator3.func_983_a(d26, p_35922_3_ + 0, d29, d6, d9);
            tessellator3.func_983_a(d26, p_35922_3_ + 1, d29, d6, d8);
            tessellator3 = tessellator8;
            if(!flag8 && !flag7)
            {
                tessellator3.func_983_a(d26, p_35922_3_ + 1, d33, d20, d22);
                tessellator3.func_983_a(d26, p_35922_3_ + 0, d33, d20, d24);
                tessellator3.func_983_a(d26, p_35922_3_ + 0, d34, d21, d24);
                tessellator3.func_983_a(d26, p_35922_3_ + 1, d34, d21, d22);
                tessellator3.func_983_a(d26, p_35922_3_ + 1, d34, d20, d22);
                tessellator3.func_983_a(d26, p_35922_3_ + 0, d34, d20, d24);
                tessellator3.func_983_a(d26, p_35922_3_ + 0, d33, d21, d24);
                tessellator3.func_983_a(d26, p_35922_3_ + 1, d33, d21, d22);
            }
            if(flag11 || p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_ + 1, p_35922_3_ + 1, p_35922_4_))
            {
                tessellator3.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d22);
                tessellator3.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                tessellator3.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                tessellator3.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d22);
                tessellator3.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d22);
                tessellator3.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d34, d21, d23);
                tessellator3.func_983_a(d26, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d23);
                tessellator3.func_983_a(d27, (double)(p_35922_3_ + 1) + 0.01D, d33, d20, d22);
            }
            if(flag12 || p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_ + 1, p_35922_3_ - 1, p_35922_4_))
            {
                tessellator3.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d22);
                tessellator3.func_983_a(d27, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                tessellator3.func_983_a(d27, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                tessellator3.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d22);
                tessellator3.func_983_a(d27, (double)p_35922_3_ - 0.01D, d34, d21, d22);
                tessellator3.func_983_a(d26, (double)p_35922_3_ - 0.01D, d34, d21, d23);
                tessellator3.func_983_a(d26, (double)p_35922_3_ - 0.01D, d33, d20, d23);
                tessellator3.func_983_a(d27, (double)p_35922_3_ - 0.01D, d33, d20, d22);
            }
        }
        if(flag7 && flag8 || !flag9 && !flag10 && !flag7 && !flag8)
        {
            Tessellator tessellator4 = tessellator7;
            tessellator4.func_983_a(d26, p_35922_3_ + 1, d30, d15, d18);
            tessellator4.func_983_a(d26, p_35922_3_ + 0, d30, d15, d19);
            tessellator4.func_983_a(d26, p_35922_3_ + 0, d28, d17, d19);
            tessellator4.func_983_a(d26, p_35922_3_ + 1, d28, d17, d18);
            tessellator4.func_983_a(d26, p_35922_3_ + 1, d28, d10, d13);
            tessellator4.func_983_a(d26, p_35922_3_ + 0, d28, d10, d14);
            tessellator4.func_983_a(d26, p_35922_3_ + 0, d30, d12, d14);
            tessellator4.func_983_a(d26, p_35922_3_ + 1, d30, d12, d13);
            tessellator4 = tessellator8;
            if(flag11)
            {
                tessellator4.func_983_a(d32, p_35922_3_ + 1, d30, d21, d24);
                tessellator4.func_983_a(d32, p_35922_3_ + 1, d28, d21, d22);
                tessellator4.func_983_a(d31, p_35922_3_ + 1, d28, d20, d22);
                tessellator4.func_983_a(d31, p_35922_3_ + 1, d30, d20, d24);
                tessellator4.func_983_a(d32, p_35922_3_ + 1, d28, d21, d24);
                tessellator4.func_983_a(d32, p_35922_3_ + 1, d30, d21, d22);
                tessellator4.func_983_a(d31, p_35922_3_ + 1, d30, d20, d22);
                tessellator4.func_983_a(d31, p_35922_3_ + 1, d28, d20, d24);
            } else
            {
                if(p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ + 1, p_35922_4_ - 1))
                {
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d28, d21, d22);
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d29, d21, d23);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d29, d20, d23);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d28, d20, d22);
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d29, d21, d22);
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d28, d21, d23);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d28, d20, d23);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d29, d20, d22);
                }
                if(p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ + 1, p_35922_4_ + 1))
                {
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d29, d20, d23);
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d30, d20, d24);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d30, d21, d24);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d29, d21, d23);
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d30, d20, d23);
                    tessellator4.func_983_a(d31, p_35922_3_ + 1, d29, d20, d24);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d29, d21, d24);
                    tessellator4.func_983_a(d32, p_35922_3_ + 1, d30, d21, d23);
                }
            }
            if(flag12)
            {
                tessellator4.func_983_a(d32, p_35922_3_, d30, d21, d24);
                tessellator4.func_983_a(d32, p_35922_3_, d28, d21, d22);
                tessellator4.func_983_a(d31, p_35922_3_, d28, d20, d22);
                tessellator4.func_983_a(d31, p_35922_3_, d30, d20, d24);
                tessellator4.func_983_a(d32, p_35922_3_, d28, d21, d24);
                tessellator4.func_983_a(d32, p_35922_3_, d30, d21, d22);
                tessellator4.func_983_a(d31, p_35922_3_, d30, d20, d22);
                tessellator4.func_983_a(d31, p_35922_3_, d28, d20, d24);
            } else
            {
                if(p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ - 1, p_35922_4_ - 1))
                {
                    tessellator4.func_983_a(d31, p_35922_3_, d28, d21, d22);
                    tessellator4.func_983_a(d31, p_35922_3_, d29, d21, d23);
                    tessellator4.func_983_a(d32, p_35922_3_, d29, d20, d23);
                    tessellator4.func_983_a(d32, p_35922_3_, d28, d20, d22);
                    tessellator4.func_983_a(d31, p_35922_3_, d29, d21, d22);
                    tessellator4.func_983_a(d31, p_35922_3_, d28, d21, d23);
                    tessellator4.func_983_a(d32, p_35922_3_, d28, d20, d23);
                    tessellator4.func_983_a(d32, p_35922_3_, d29, d20, d22);
                }
                if(p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ - 1, p_35922_4_ + 1))
                {
                    tessellator4.func_983_a(d31, p_35922_3_, d29, d20, d23);
                    tessellator4.func_983_a(d31, p_35922_3_, d30, d20, d24);
                    tessellator4.func_983_a(d32, p_35922_3_, d30, d21, d24);
                    tessellator4.func_983_a(d32, p_35922_3_, d29, d21, d23);
                    tessellator4.func_983_a(d31, p_35922_3_, d30, d20, d23);
                    tessellator4.func_983_a(d31, p_35922_3_, d29, d20, d24);
                    tessellator4.func_983_a(d32, p_35922_3_, d29, d21, d24);
                    tessellator4.func_983_a(d32, p_35922_3_, d30, d21, d23);
                }
            }
        } else
        if(flag7 && !flag8)
        {
            ...
            tessellator5.func_983_a(d26, p_35922_3_ + 1, d28, d10, d13);
            tessellator5.func_983_a(d26, p_35922_3_ + 0, d28, d10, d14);
            tessellator5.func_983_a(d26, p_35922_3_ + 0, d29, d11, d14);
            tessellator5.func_983_a(d26, p_35922_3_ + 1, d29, d11, d13);
            tessellator5.func_983_a(d26, p_35922_3_ + 1, d29, d16, d18);
            tessellator5.func_983_a(d26, p_35922_3_ + 0, d29, d16, d19);
            tessellator5.func_983_a(d26, p_35922_3_ + 0, d28, d17, d19);
            tessellator5.func_983_a(d26, p_35922_3_ + 1, d28, d17, d18);
            tessellator5 = tessellator8;
            if(!flag10 && !flag9)
            {
                tessellator5.func_983_a(d31, p_35922_3_ + 1, d29, d20, d22);
                tessellator5.func_983_a(d31, p_35922_3_ + 0, d29, d20, d24);
                tessellator5.func_983_a(d32, p_35922_3_ + 0, d29, d21, d24);
                tessellator5.func_983_a(d32, p_35922_3_ + 1, d29, d21, d22);
                tessellator5.func_983_a(d32, p_35922_3_ + 1, d29, d20, d22);
                tessellator5.func_983_a(d32, p_35922_3_ + 0, d29, d20, d24);
                tessellator5.func_983_a(d31, p_35922_3_ + 0, d29, d21, d24);
                tessellator5.func_983_a(d31, p_35922_3_ + 1, d29, d21, d22);
            }
            if(flag11 || p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ + 1, p_35922_4_ - 1))
            {
                tessellator5.func_983_a(d31, p_35922_3_ + 1, d28, d21, d22);
                tessellator5.func_983_a(d31, p_35922_3_ + 1, d29, d21, d23);
                tessellator5.func_983_a(d32, p_35922_3_ + 1, d29, d20, d23);
                tessellator5.func_983_a(d32, p_35922_3_ + 1, d28, d20, d22);
                tessellator5.func_983_a(d31, p_35922_3_ + 1, d29, d21, d22);
                tessellator5.func_983_a(d31, p_35922_3_ + 1, d28, d21, d23);
                tessellator5.func_983_a(d32, p_35922_3_ + 1, d28, d20, d23);
                tessellator5.func_983_a(d32, p_35922_3_ + 1, d29, d20, d22);
            }
            if(flag12 || p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ - 1, p_35922_4_ - 1))
            {
                tessellator5.func_983_a(d31, p_35922_3_, d28, d21, d22);
                tessellator5.func_983_a(d31, p_35922_3_, d29, d21, d23);
                tessellator5.func_983_a(d32, p_35922_3_, d29, d20, d23);
                tessellator5.func_983_a(d32, p_35922_3_, d28, d20, d22);
                tessellator5.func_983_a(d31, p_35922_3_, d29, d21, d22);
                tessellator5.func_983_a(d31, p_35922_3_, d28, d21, d23);
                tessellator5.func_983_a(d32, p_35922_3_, d28, d20, d23);
                tessellator5.func_983_a(d32, p_35922_3_, d29, d20, d22);
            }
        } else
        if(!flag7 && flag8)
        {
            Tessellator tessellator6 = tessellator7;
            tessellator6.func_983_a(d26, p_35922_3_ + 1, d29, d11, d13);
            tessellator6.func_983_a(d26, p_35922_3_ + 0, d29, d11, d14);
            tessellator6.func_983_a(d26, p_35922_3_ + 0, d30, d12, d14);
            tessellator6.func_983_a(d26, p_35922_3_ + 1, d30, d12, d13);
            tessellator6.func_983_a(d26, p_35922_3_ + 1, d30, d15, d18);
            tessellator6.func_983_a(d26, p_35922_3_ + 0, d30, d15, d19);
            tessellator6.func_983_a(d26, p_35922_3_ + 0, d29, d16, d19);
            tessellator6.func_983_a(d26, p_35922_3_ + 1, d29, d16, d18);
            tessellator6 = tessellator8;
            if(!flag10 && !flag9)
            {
                tessellator6.func_983_a(d32, p_35922_3_ + 1, d29, d20, d22);
                tessellator6.func_983_a(d32, p_35922_3_ + 0, d29, d20, d24);
                tessellator6.func_983_a(d31, p_35922_3_ + 0, d29, d21, d24);
                tessellator6.func_983_a(d31, p_35922_3_ + 1, d29, d21, d22);
                tessellator6.func_983_a(d31, p_35922_3_ + 1, d29, d20, d22);
                tessellator6.func_983_a(d31, p_35922_3_ + 0, d29, d20, d24);
                tessellator6.func_983_a(d32, p_35922_3_ + 0, d29, d21, d24);
                tessellator6.func_983_a(d32, p_35922_3_ + 1, d29, d21, d22);
            }
            if(flag11 || p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ + 1, p_35922_4_ + 1))
            {
                tessellator6.func_983_a(d31, p_35922_3_ + 1, d29, d20, d23);
                tessellator6.func_983_a(d31, p_35922_3_ + 1, d30, d20, d24);
                tessellator6.func_983_a(d32, p_35922_3_ + 1, d30, d21, d24);
                tessellator6.func_983_a(d32, p_35922_3_ + 1, d29, d21, d23);
                tessellator6.func_983_a(d31, p_35922_3_ + 1, d30, d20, d23);
                tessellator6.func_983_a(d31, p_35922_3_ + 1, d29, d20, d24);
                tessellator6.func_983_a(d32, p_35922_3_ + 1, d29, d21, d24);
                tessellator6.func_983_a(d32, p_35922_3_ + 1, d30, d21, d23);
            }
            if(flag12 || p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ - 1, p_35922_4_ + 1))
            {
                tessellator6.func_983_a(d31, p_35922_3_, d29, d20, d23);
                tessellator6.func_983_a(d31, p_35922_3_, d30, d20, d24);
                tessellator6.func_983_a(d32, p_35922_3_, d30, d21, d24);
                tessellator6.func_983_a(d32, p_35922_3_, d29, d21, d23);
                tessellator6.func_983_a(d31, p_35922_3_, d30, d20, d23);
                tessellator6.func_983_a(d31, p_35922_3_, d29, d20, d24);
                tessellator6.func_983_a(d32, p_35922_3_, d29, d21, d24);
                tessellator6.func_983_a(d32, p_35922_3_, d30, d21, d23);
            }
        }
        if(Config.isBetterSnow() && hasSnowNeighbours(p_35922_2_, p_35922_3_, p_35922_4_))
        {
            func_1228_k(Block.field_428_aT, p_35922_2_, p_35922_3_, p_35922_4_);
        }
        return true;
    }
    ...
    public boolean func_1226_h(Block p_1226_1_, int p_1226_2_, int p_1226_3_, int p_1226_4_)
    {
        ...
        float f = 1.0F;
        int i = CustomColorizer.getColorMultiplier(p_1226_1_, field_1772_a, p_1226_2_, p_1226_3_, p_1226_4_);
        float f1 = (float)(i >> 16 & 0xff) / 255F;
        float f2 = (float)(i >> 8 & 0xff) / 255F;
        float f3 = (float)(i & 0xff) / 255F;
        if(EntityRenderer.field_28135_a)
        ...
        if(Config.isBetterSnow() && hasSnowNeighbours(p_1226_2_, p_1226_3_, p_1226_4_))
        {
            func_1228_k(Block.field_428_aT, p_1226_2_, p_1226_3_, p_1226_4_);
        }
        return true;
    }
    ...
    public boolean func_1232_i(Block p_1232_1_, int p_1232_2_, int p_1232_3_, int p_1232_4_)
    {
        ...
        float f = 1.0F;
        int i = CustomColorizer.getStemColorMultiplier(blockstem, field_1772_a, p_1232_2_, p_1232_3_, p_1232_4_);
        float f1 = (float)(i >> 16 & 0xff) / 255F;
        float f2 = (float)(i >> 8 & 0xff) / 255F;
        float f3 = (float)(i & 0xff) / 255F;
        if(EntityRenderer.field_28135_a)
    ...
    public boolean func_40726_m(Block p_40726_1_, int p_40726_2_, int p_40726_3_, int p_40726_4_)
    {
        ...
        int j1 = CustomColorizer.getLilypadColor();
        tessellator.func_990_b(j1);
        ...
        tessellator.func_990_b((j1 & 0xfefefe) >> 1);
        tessellator.func_983_a(f1 - f3 - f4, (float)p_40726_3_ + f, (f2 + f3) - f4, d, d3);
        tessellator.func_983_a((f1 - f3) + f4, (float)p_40726_3_ + f, f2 - f3 - f4, d1, d3);
        tessellator.func_983_a(f1 + f3 + f4, (float)p_40726_3_ + f, (f2 - f3) + f4, d1, d2);
        tessellator.func_983_a((f1 + f3) - f4, (float)p_40726_3_ + f, f2 + f3 + f4, d, d2);
    ...
    {
        Tessellator tessellator = Tessellator.field_1512_a;
        int i = CustomColorizer.getFluidColor(p_1222_1_, field_1772_a, p_1222_2_, p_1222_3_, p_1222_4_);
        ...
        if(field_1773_d || flag1)
        {
            ...
            float f7 = 1.0F;
            tessellator.func_987_a(f3 * f7 * f, f3 * f7 * f1, f3 * f7 * f2);
    ...
    {
        int i = CustomColorizer.getColorMultiplier(p_1228_1_, field_1772_a, p_1228_2_, p_1228_3_, p_1228_4_);
        float f = (float)(i >> 16 & 0xff) / 255F;
        float f1 = (float)(i >> 8 & 0xff) / 255F;
        float f2 = (float)(i & 0xff) / 255F;
        if(EntityRenderer.field_28135_a)
    ...
    {
        field_22385_e = true;
        boolean flag = Config.isBetterGrass();
        if(p_22330_1_.getClass() == (net.minecraft.src.BlockGlass.class))
        {
            field_35946_aj = 0;
        } else
        {
        ...
        {
            flag2 = flag4 = flag5 = flag6 = flag7 = false;
        }
        if(field_1771_b >= 0)
        {
            flag2 = flag4 = flag5 = flag6 = flag7 = false;
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_, 0))
        {
            ...
            {
                calculateAoLightValues(p_22330_1_, p_22330_2_, p_22330_3_, p_22330_4_);
            }
            int j = i;
            if(p_22330_1_.field_368_bg <= 0.0D)
            {
                j = p_22330_1_.func_35275_c(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_);
            }
            float f;
            float f6;
            float f12;
            ...
            if(field_35946_aj > 0)
            {
                ...
                field_22376_n = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_);
                field_22374_p = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ - 1);
                field_22373_q = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1);
                field_22371_s = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_);
                if(field_22361_ab || field_22357_ad)
                {
                    field_22377_m = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_ - 1);
                ...
                {
                    field_22375_o = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_ + 1);
                ...
                {
                    field_22372_r = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_ - 1);
                ...
                {
                    field_22370_t = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_ + 1);
                ...
                f = (field_22375_o + field_22376_n + field_22373_q + field_22382_h) / 4F;
                f18 = (field_22373_q + field_22382_h + field_22370_t + field_22371_s) / 4F;
                f12 = (field_22382_h + field_22374_p + field_22371_s + field_22372_r) / 4F;
                f6 = (field_22376_n + field_22377_m + field_22382_h + field_22374_p) / 4F;
                field_35943_ak = func_35924_c(field_35938_R, field_35935_Q, field_35932_T, j);
                field_35948_an = func_35924_c(field_35932_T, field_35933_W, field_35934_V, j);
                field_35947_am = func_35924_c(field_35937_S, field_35934_V, field_35931_U, j);
                field_35944_al = func_35924_c(field_35935_Q, field_35936_P, field_35937_S, j);
            } else
            {
                f = f6 = f12 = f18 = field_22382_h;
                field_35943_ak = field_35944_al = field_35947_am = field_35948_an = j;
            }
            field_22351_H = field_22350_I = field_22349_J = field_22348_K = (flag2 ? p_22330_5_ : 1.0F) * 0.5F;
            field_22347_L = field_22346_M = field_22345_N = field_22344_O = (flag2 ? p_22330_6_ : 1.0F) * 0.5F;
            field_22343_P = field_22342_Q = field_22341_R = field_22340_S = (flag2 ? p_22330_7_ : 1.0F) * 0.5F;
            field_22351_H *= f;
            field_22347_L *= f;
            field_22343_P *= f;
            field_22350_I *= f6;
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_, 1))
        {
            ...
            if(field_35946_aj > 0)
            {
                ...
                field_22368_v = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_);
                field_22364_z = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_);
                field_22366_x = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ - 1);
                field_22362_A = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1);
                if(field_22339_T || field_22337_V)
                {
                    field_22369_u = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_ - 1);
                ...
                {
                    field_22365_y = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_ - 1);
                ...
                {
                    field_22367_w = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_ + 1);
                ...
                {
                    field_22360_B = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_ + 1);
                ...
                f19 = (field_22367_w + field_22368_v + field_22362_A + field_22379_k) / 4F;
                f1 = (field_22362_A + field_22379_k + field_22360_B + field_22364_z) / 4F;
                f7 = (field_22379_k + field_22366_x + field_22364_z + field_22365_y) / 4F;
                f13 = (field_22368_v + field_22369_u + field_22379_k + field_22366_x) / 4F;
                field_35948_an = func_35924_c(field_35941_Z, field_35939_Y, field_35950_ad, k);
                field_35943_ak = func_35924_c(field_35950_ad, field_35955_ae, field_35949_ac, k);
                field_35944_al = func_35924_c(field_35951_aa, field_35949_ac, field_35952_ab, k);
                field_35947_am = func_35924_c(field_35939_Y, field_35940_X, field_35951_aa, k);
            } else
            {
                f1 = f7 = f13 = f19 = field_22379_k;
                field_35943_ak = field_35944_al = field_35947_am = field_35948_an = k;
            }
            field_22351_H = field_22350_I = field_22349_J = field_22348_K = flag3 ? p_22330_5_ : 1.0F;
            field_22347_L = field_22346_M = field_22345_N = field_22344_O = flag3 ? p_22330_6_ : 1.0F;
            field_22343_P = field_22342_Q = field_22341_R = field_22340_S = flag3 ? p_22330_7_ : 1.0F;
            field_22351_H *= f1;
            field_22347_L *= f1;
            field_22343_P *= f1;
            field_22350_I *= f7;
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ - 1, 2))
        {
            ...
            if(field_35946_aj > 0)
            {
                ...
                field_22358_C = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_);
                field_22374_p = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_);
                field_22366_x = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_);
                field_22356_D = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_);
                ...
                {
                    field_22377_m = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_ - 1, p_22330_4_);
                ...
                {
                    field_22369_u = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_ + 1, p_22330_4_);
                ...
                {
                    field_22372_r = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_ - 1, p_22330_4_);
                ...
                {
                    field_22365_y = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_ + 1, p_22330_4_);
                ...
                f2 = (field_22358_C + field_22369_u + field_22381_i + field_22366_x) / 4F;
                f8 = (field_22381_i + field_22366_x + field_22356_D + field_22365_y) / 4F;
                f14 = (field_22374_p + field_22381_i + field_22372_r + field_22356_D) / 4F;
                f20 = (field_22377_m + field_22358_C + field_22374_p + field_22381_i) / 4F;
            ...
            if(flag)
            {
                l1 = fixAoSideGrassTexture(l1, p_22330_2_, p_22330_3_, p_22330_4_, 2, p_22330_5_, p_22330_6_, p_22330_7_);
            }
            func_1220_c(p_22330_1_, p_22330_2_, p_22330_3_, p_22330_4_, l1);
            if(Tessellator.field_1512_a.defaultTexture && field_27406_a && l1 == 3 && field_1771_b < 0)
            {
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1, 3))
        {
            ...
            {
                i1 = p_22330_1_.func_35275_c(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1);
            }
            float f3;
            float f9;
            float f15;
            ...
            if(field_35946_aj > 0)
            {
                ...
                field_22354_E = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_);
                field_22353_F = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_);
                field_22373_q = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_);
                field_22362_A = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_);
                ...
                {
                    field_22375_o = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_ - 1, p_22330_4_);
                ...
                {
                    field_22367_w = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ - 1, p_22330_3_ + 1, p_22330_4_);
                ...
                {
                    field_22370_t = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_ - 1, p_22330_4_);
                ...
                {
                    field_22360_B = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_ + 1, p_22330_3_ + 1, p_22330_4_);
                ...
                f3 = (field_22354_E + field_22367_w + field_22378_l + field_22362_A) / 4F;
                f21 = (field_22378_l + field_22362_A + field_22353_F + field_22360_B) / 4F;
                f15 = (field_22373_q + field_22378_l + field_22370_t + field_22353_F) / 4F;
                f9 = (field_22375_o + field_22354_E + field_22373_q + field_22378_l) / 4F;
                field_35943_ak = func_35924_c(field_35954_ah, field_35941_Z, field_35950_ad, i1);
                field_35948_an = func_35924_c(field_35950_ad, field_35945_ai, field_35955_ae, i1);
                field_35947_am = func_35924_c(field_35932_T, field_35933_W, field_35945_ai, i1);
                field_35944_al = func_35924_c(field_35938_R, field_35954_ah, field_35932_T, i1);
            } else
            {
                f3 = f9 = f15 = f21 = field_22378_l;
                field_35943_ak = field_35944_al = field_35947_am = field_35948_an = i1;
            }
            field_22351_H = field_22350_I = field_22349_J = field_22348_K = (flag5 ? p_22330_5_ : 1.0F) * 0.8F;
            field_22347_L = field_22346_M = field_22345_N = field_22344_O = (flag5 ? p_22330_6_ : 1.0F) * 0.8F;
            field_22343_P = field_22342_Q = field_22341_R = field_22340_S = (flag5 ? p_22330_7_ : 1.0F) * 0.8F;
            field_22351_H *= f3;
            field_22347_L *= f3;
            field_22343_P *= f3;
            field_22350_I *= f9;
            ...
            if(flag)
            {
                i2 = fixAoSideGrassTexture(i2, p_22330_2_, p_22330_3_, p_22330_4_, 3, p_22330_5_, p_22330_6_, p_22330_7_);
            }
            func_1225_d(p_22330_1_, p_22330_2_, p_22330_3_, p_22330_4_, i2);
            if(Tessellator.field_1512_a.defaultTexture && field_27406_a && i2 == 3 && field_1771_b < 0)
            {
                field_22351_H *= p_22330_5_;
                field_22350_I *= p_22330_5_;
                field_22349_J *= p_22330_5_;
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_, 4))
        {
            ...
            {
                j1 = p_22330_1_.func_35275_c(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_);
            }
            float f4;
            float f10;
            float f16;
            ...
            if(field_35946_aj > 0)
            {
                ...
                field_22376_n = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_);
                field_22358_C = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ - 1);
                field_22354_E = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1);
                field_22368_v = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_);
                ...
                {
                    field_22377_m = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_ - 1);
                ...
                {
                    field_22375_o = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_ + 1);
                ...
                {
                    field_22369_u = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_ - 1);
                ...
                {
                    field_22367_w = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_ + 1);
                ...
                f22 = (field_22376_n + field_22375_o + field_22383_g + field_22354_E) / 4F;
                f4 = (field_22383_g + field_22354_E + field_22368_v + field_22367_w) / 4F;
                f10 = (field_22358_C + field_22383_g + field_22369_u + field_22368_v) / 4F;
                f16 = (field_22377_m + field_22376_n + field_22358_C + field_22383_g) / 4F;
                field_35948_an = func_35924_c(field_35935_Q, field_35938_R, field_35954_ah, j1);
                field_35943_ak = func_35924_c(field_35954_ah, field_35939_Y, field_35941_Z, j1);
                field_35944_al = func_35924_c(field_35956_af, field_35940_X, field_35939_Y, j1);
                field_35947_am = func_35924_c(field_35936_P, field_35935_Q, field_35956_af, j1);
            } else
            {
                f4 = f10 = f16 = f22 = field_22383_g;
            ...
            if(flag)
            {
                j2 = fixAoSideGrassTexture(j2, p_22330_2_, p_22330_3_, p_22330_4_, 4, p_22330_5_, p_22330_6_, p_22330_7_);
            }
            func_1231_e(p_22330_1_, p_22330_2_, p_22330_3_, p_22330_4_, j2);
            if(Tessellator.field_1512_a.defaultTexture && field_27406_a && j2 == 3 && field_1771_b < 0)
            {
                field_22351_H *= p_22330_5_;
                field_22350_I *= p_22330_5_;
                field_22349_J *= p_22330_5_;
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_, 5))
        {
            ...
            {
                k1 = p_22330_1_.func_35275_c(field_1772_a, p_22330_2_ + 1, p_22330_3_, p_22330_4_);
            }
            float f5;
            float f11;
            float f17;
            ...
            if(field_35946_aj > 0)
            {
                ...
                field_22371_s = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_);
                field_22356_D = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ - 1);
                field_22353_F = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1);
                field_22364_z = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_);
                ...
                {
                    field_22372_r = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_ - 1);
                ...
                {
                    field_22370_t = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ - 1, p_22330_4_ + 1);
                ...
                {
                    field_22365_y = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_ - 1);
                ...
                {
                    field_22360_B = getAmbientOcclusionLightValue(field_1772_a, p_22330_2_, p_22330_3_ + 1, p_22330_4_ + 1);
                ...
                f5 = (field_22371_s + field_22370_t + field_22380_j + field_22353_F) / 4F;
                f23 = (field_22380_j + field_22353_F + field_22364_z + field_22360_B) / 4F;
                f17 = (field_22356_D + field_22380_j + field_22365_y + field_22364_z) / 4F;
                f11 = (field_22372_r + field_22371_s + field_22356_D + field_22380_j) / 4F;
            ...
            {
                f5 = f11 = f17 = f23 = field_22380_j;
                field_35943_ak = field_35944_al = field_35947_am = field_35948_an = k1;
            }
            field_22351_H = field_22350_I = field_22349_J = field_22348_K = (flag7 ? p_22330_5_ : 1.0F) * 0.6F;
            field_22347_L = field_22346_M = field_22345_N = field_22344_O = (flag7 ? p_22330_6_ : 1.0F) * 0.6F;
            field_22343_P = field_22342_Q = field_22341_R = field_22340_S = (flag7 ? p_22330_7_ : 1.0F) * 0.6F;
            field_22351_H *= f5;
            field_22347_L *= f5;
            field_22343_P *= f5;
            field_22350_I *= f11;
            ...
            if(flag)
            {
                k2 = fixAoSideGrassTexture(k2, p_22330_2_, p_22330_3_, p_22330_4_, 5, p_22330_5_, p_22330_6_, p_22330_7_);
            }
            func_1236_f(p_22330_1_, p_22330_2_, p_22330_3_, p_22330_4_, k2);
            if(Tessellator.field_1512_a.defaultTexture && field_27406_a && k2 == 3 && field_1771_b < 0)
            {
                field_22351_H *= p_22330_5_;
                field_22350_I *= p_22330_5_;
                field_22349_J *= p_22330_5_;
    ...
    {
        field_22383_g = getAmbientOcclusionLightValue(field_1772_a, i - 1, j, k);
        field_22382_h = getAmbientOcclusionLightValue(field_1772_a, i, j - 1, k);
        field_22381_i = getAmbientOcclusionLightValue(field_1772_a, i, j, k - 1);
        field_22380_j = getAmbientOcclusionLightValue(field_1772_a, i + 1, j, k);
        field_22379_k = getAmbientOcclusionLightValue(field_1772_a, i, j + 1, k);
        field_22378_l = getAmbientOcclusionLightValue(field_1772_a, i, j, k + 1);
    ...
    {
        Block block = Block.field_345_n[iblockaccess.func_600_a(i, j, k)];
        if(block == null)
        {
            return 1.0F;
        }
        ...
        {
            return !block.field_356_bn.func_880_c() || !block.func_242_c() ? 1.0F : aoLightValueOpaque;
        }
    }

    private int fixAoSideGrassTexture(int i, int j, int k, int l, int i1, float f, float f1, 
            float f2)
    {
        if(!Tessellator.field_1512_a.defaultTexture)
        {
            return i;
        }
        if(i == 3)
        {
            i = Config.getSideGrassTexture(field_1772_a, j, k, l, i1);
            if(i == 0)
            {
                field_22351_H *= f;
                field_22350_I *= f;
        ...
        if(i == 68)
        {
            i = Config.getSideSnowGrassTexture(field_1772_a, j, k, l, i1);
        }
        return i;
    }
    ...
    public boolean func_4152_a(Block p_4152_1_, int p_4152_2_, int p_4152_3_, int p_4152_4_, float p_4152_5_, float p_4152_6_, float p_4152_7_)
    {
        ...
        {
            tessellator.func_35835_b(p_4152_1_.field_368_bg > 0.0D ? i : p_4152_1_.func_35275_c(field_1772_a, p_4152_2_, p_4152_3_ - 1, p_4152_4_));
            tessellator.func_987_a(f7, f10, f13);
        ...
        {
            tessellator.func_35835_b(p_4152_1_.field_362_bj < 1.0D ? i : p_4152_1_.func_35275_c(field_1772_a, p_4152_2_, p_4152_3_ + 1, p_4152_4_));
            tessellator.func_987_a(f4, f5, f6);
        ...
        {
            tessellator.func_35835_b(p_4152_1_.field_366_bh > 0.0D ? i : p_4152_1_.func_35275_c(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_ - 1));
            tessellator.func_987_a(f8, f11, f14);
            ...
            if(flag)
            {
                if(j == 3)
                {
                    j = Config.getSideGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 2);
                    if(j == 0)
                    {
                ...
                if(j == 68)
                {
                    j = Config.getSideSnowGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 2);
                }
            }
            func_1220_c(p_4152_1_, p_4152_2_, p_4152_3_, p_4152_4_, j);
            if((Tessellator.field_1512_a.defaultTexture && field_27406_a || Config.isBetterGrass()) && j == 3 && field_1771_b < 0)
            {
                tessellator.func_987_a(f8 * p_4152_5_, f11 * p_4152_6_, f14 * p_4152_7_);
        ...
        {
            tessellator.func_35835_b(p_4152_1_.field_360_bk < 1.0D ? i : p_4152_1_.func_35275_c(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_ + 1));
            tessellator.func_987_a(f8, f11, f14);
            ...
            if(flag)
            {
                if(k == 3)
                {
                    k = Config.getSideGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 3);
                    if(k == 0)
                    {
                        tessellator.func_987_a(f8 * p_4152_5_, f11 * p_4152_6_, f14 * p_4152_7_);
                    }
                ...
                if(k == 68)
                {
                    k = Config.getSideSnowGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 3);
                }
            }
            func_1225_d(p_4152_1_, p_4152_2_, p_4152_3_, p_4152_4_, k);
            if((Tessellator.field_1512_a.defaultTexture && field_27406_a || Config.isBetterGrass()) && k == 3 && field_1771_b < 0)
            {
                tessellator.func_987_a(f8 * p_4152_5_, f11 * p_4152_6_, f14 * p_4152_7_);
        ...
        {
            tessellator.func_35835_b(p_4152_1_.field_370_bf > 0.0D ? i : p_4152_1_.func_35275_c(field_1772_a, p_4152_2_ - 1, p_4152_3_, p_4152_4_));
            tessellator.func_987_a(f9, f12, f15);
            ...
            if(flag)
            {
                if(l == 3)
                {
                    l = Config.getSideGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 4);
                    if(l == 0)
                    {
                        tessellator.func_987_a(f8 * p_4152_5_, f11 * p_4152_6_, f14 * p_4152_7_);
                    }
                ...
                if(l == 68)
                {
                    l = Config.getSideSnowGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 4);
                }
            }
            func_1231_e(p_4152_1_, p_4152_2_, p_4152_3_, p_4152_4_, l);
            if((Tessellator.field_1512_a.defaultTexture && field_27406_a || Config.isBetterGrass()) && l == 3 && field_1771_b < 0)
            {
        ...
        {
            tessellator.func_35835_b(p_4152_1_.field_364_bi < 1.0D ? i : p_4152_1_.func_35275_c(field_1772_a, p_4152_2_ + 1, p_4152_3_, p_4152_4_));
            tessellator.func_987_a(f9, f12, f15);
            ...
            if(flag)
            {
                if(i1 == 3)
                {
                    i1 = Config.getSideGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 5);
                    if(i1 == 0)
                    {
                        tessellator.func_987_a(f8 * p_4152_5_, f11 * p_4152_6_, f14 * p_4152_7_);
                    }
                ...
                if(i1 == 68)
                {
                    i1 = Config.getSideSnowGrassTexture(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_, 5);
                }
            }
            func_1236_f(p_4152_1_, p_4152_2_, p_4152_3_, p_4152_4_, i1);
            if((Tessellator.field_1512_a.defaultTexture && field_27406_a || Config.isBetterGrass()) && i1 == 3 && field_1771_b < 0)
            {
                tessellator.func_987_a(f9 * p_4152_5_, f12 * p_4152_6_, f15 * p_4152_7_);
    ...
    public boolean func_1230_b(Block p_1230_1_, int p_1230_2_, int p_1230_3_, int p_1230_4_, float p_1230_5_, float p_1230_6_, float p_1230_7_)
    {
        ...
        {
            tessellator.func_35835_b(p_1230_1_.field_368_bg > 0.0D ? i : p_1230_1_.func_35275_c(field_1772_a, p_1230_2_, p_1230_3_ - 1, p_1230_4_));
        ...
        {
            tessellator.func_35835_b(p_1230_1_.field_362_bj < 1.0D ? i : p_1230_1_.func_35275_c(field_1772_a, p_1230_2_, p_1230_3_ + 1, p_1230_4_));
        ...
        {
            tessellator.func_35835_b(p_1230_1_.field_366_bh > 0.0D ? i : p_1230_1_.func_35275_c(field_1772_a, p_1230_2_, p_1230_3_, p_1230_4_ - 1));
        ...
        {
            tessellator.func_35835_b(p_1230_1_.field_360_bk < 1.0D ? i : p_1230_1_.func_35275_c(field_1772_a, p_1230_2_, p_1230_3_, p_1230_4_ + 1));
            tessellator.func_987_a(f6, f10, f14);
            tessellator.func_988_c(0.0F, 0.0F, -f16);
        ...
        {
            tessellator.func_35835_b(p_1230_1_.field_370_bf > 0.0D ? i : p_1230_1_.func_35275_c(field_1772_a, p_1230_2_ - 1, p_1230_3_, p_1230_4_));
        ...
        {
            tessellator.func_35835_b(p_1230_1_.field_364_bi < 1.0D ? i : p_1230_1_.func_35275_c(field_1772_a, p_1230_2_ + 1, p_1230_3_, p_1230_4_));
            tessellator.func_987_a(f7, f11, f15);
            tessellator.func_988_c(-f16, 0.0F, 0.0F);
    ...
    public boolean func_35925_a(BlockFence p_35925_1_, int p_35925_2_, int p_35925_3_, int p_35925_4_)
    {
        ...
        if(Config.isBetterSnow() && hasSnowNeighbours(p_35925_2_, p_35925_3_, p_35925_4_))
        {
            func_1228_k(Block.field_428_aT, p_35925_2_, p_35925_3_, p_35925_4_);
        }
        return flag;
    }
    ...
    public boolean func_1218_o(Block p_1218_1_, int p_1218_2_, int p_1218_3_, int p_1218_4_)
    {
        ...
        tessellator.func_35835_b(p_1218_1_.field_368_bg > 0.0D ? i : p_1218_1_.func_35275_c(field_1772_a, p_1218_2_, p_1218_3_ - 1, p_1218_4_));
        tessellator.func_987_a(f, f, f);
        func_1244_a(p_1218_1_, p_1218_2_, p_1218_3_, p_1218_4_, p_1218_1_.func_211_a(field_1772_a, p_1218_2_, p_1218_3_, p_1218_4_, 0));
        flag = true;
        tessellator.func_35835_b(p_1218_1_.field_362_bj < 1.0D ? i : p_1218_1_.func_35275_c(field_1772_a, p_1218_2_, p_1218_3_ + 1, p_1218_4_));
        ...
        flag = true;
        tessellator.func_35835_b(p_1218_1_.field_366_bh > 0.0D ? i : p_1218_1_.func_35275_c(field_1772_a, p_1218_2_, p_1218_3_, p_1218_4_ - 1));
        ...
        flag = true;
        field_1774_c = false;
        tessellator.func_35835_b(p_1218_1_.field_360_bk < 1.0D ? i : p_1218_1_.func_35275_c(field_1772_a, p_1218_2_, p_1218_3_, p_1218_4_ + 1));
        tessellator.func_987_a(f2, f2, f2);
        ...
        flag = true;
        field_1774_c = false;
        tessellator.func_35835_b(p_1218_1_.field_370_bf > 0.0D ? i : p_1218_1_.func_35275_c(field_1772_a, p_1218_2_ - 1, p_1218_3_, p_1218_4_));
        tessellator.func_987_a(f3, f3, f3);
        ...
        flag = true;
        field_1774_c = false;
        tessellator.func_35835_b(p_1218_1_.field_364_bi < 1.0D ? i : p_1218_1_.func_35275_c(field_1772_a, p_1218_2_ + 1, p_1218_3_, p_1218_4_));
        tessellator.func_987_a(f3, f3, f3);
            ...
            int p_1244_8_)
    {
        ...
        if(Config.isConnectedTextures() && field_1771_b < 0)
        {
            int i = getConnectedTexture(p_1244_1_, (int)p_1244_2_, (int)p_1244_4_, (int)p_1244_6_, 0);
            if(i >= 0)
            {
                int k = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator = Tessellator.field_1512_a.getSubTessellator(k);
                p_1244_8_ = i;
            }
        }
        int j = (p_1244_8_ & 0xf) << 4;
        int l = p_1244_8_ & 0xf0;
        double d = ((double)j + p_1244_1_.field_370_bf * 16D) / 256D;
        double d1 = (((double)j + p_1244_1_.field_364_bi * 16D) - 0.01D) / 256D;
        double d2 = ((double)l + p_1244_1_.field_366_bh * 16D) / 256D;
        double d3 = (((double)l + p_1244_1_.field_360_bk * 16D) - 0.01D) / 256D;
        ...
        if(field_31082_l == 2)
        {
            d = ((double)j + p_1244_1_.field_366_bh * 16D) / 256D;
            d2 = ((double)(l + 16) - p_1244_1_.field_364_bi * 16D) / 256D;
            d1 = ((double)j + p_1244_1_.field_360_bk * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1244_1_.field_370_bf * 16D) / 256D;
            d4 = d1;
            d5 = d;
            d6 = d2;
            d7 = d3;
        ...
        if(field_31082_l == 1)
        {
            d = ((double)(j + 16) - p_1244_1_.field_360_bk * 16D) / 256D;
            d2 = ((double)l + p_1244_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1244_1_.field_366_bh * 16D) / 256D;
            d3 = ((double)l + p_1244_1_.field_364_bi * 16D) / 256D;
            d4 = d1;
            d5 = d;
            d6 = d2;
            d7 = d3;
        ...
        if(field_31082_l == 3)
        {
            d = ((double)(j + 16) - p_1244_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1244_1_.field_364_bi * 16D - 0.01D) / 256D;
            d2 = ((double)(l + 16) - p_1244_1_.field_366_bh * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1244_1_.field_360_bk * 16D - 0.01D) / 256D;
            d4 = d1;
            d5 = d;
            d6 = d2;
            d7 = d3;
            ...
            int p_1217_8_)
    {
        ...
        if(Config.isConnectedTextures() && field_1771_b < 0)
        {
            int i = getConnectedTexture(p_1217_1_, (int)p_1217_2_, (int)p_1217_4_, (int)p_1217_6_, 1);
            if(i >= 0)
            {
                int k = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator = Tessellator.field_1512_a.getSubTessellator(k);
        ...
        int j = (p_1217_8_ & 0xf) << 4;
        int l = p_1217_8_ & 0xf0;
        double d = ((double)j + p_1217_1_.field_370_bf * 16D) / 256D;
        double d1 = (((double)j + p_1217_1_.field_364_bi * 16D) - 0.01D) / 256D;
        double d2 = ((double)l + p_1217_1_.field_366_bh * 16D) / 256D;
        double d3 = (((double)l + p_1217_1_.field_360_bk * 16D) - 0.01D) / 256D;
        ...
        if(field_31083_k == 1)
        {
            d = ((double)j + p_1217_1_.field_366_bh * 16D) / 256D;
            d2 = ((double)(l + 16) - p_1217_1_.field_364_bi * 16D) / 256D;
            d1 = ((double)j + p_1217_1_.field_360_bk * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1217_1_.field_370_bf * 16D) / 256D;
            d4 = d1;
            d5 = d;
            d6 = d2;
            d7 = d3;
        ...
        if(field_31083_k == 2)
        {
            d = ((double)(j + 16) - p_1217_1_.field_360_bk * 16D) / 256D;
            d2 = ((double)l + p_1217_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1217_1_.field_366_bh * 16D) / 256D;
            d3 = ((double)l + p_1217_1_.field_364_bi * 16D) / 256D;
            d4 = d1;
            d5 = d;
            d6 = d2;
            d7 = d3;
        ...
        if(field_31083_k == 3)
        {
            d = ((double)(j + 16) - p_1217_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1217_1_.field_364_bi * 16D - 0.01D) / 256D;
            d2 = ((double)(l + 16) - p_1217_1_.field_366_bh * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1217_1_.field_360_bk * 16D - 0.01D) / 256D;
            d4 = d1;
            d5 = d;
            d6 = d2;
            d7 = d3;
            ...
            int p_1220_8_)
    {
        ...
        if(Config.isConnectedTextures() && field_1771_b < 0)
        {
            int i = getConnectedTexture(p_1220_1_, (int)p_1220_2_, (int)p_1220_4_, (int)p_1220_6_, 2);
            if(i >= 0)
            {
                int k = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator = Tessellator.field_1512_a.getSubTessellator(k);
        ...
        int j = (p_1220_8_ & 0xf) << 4;
        int l = p_1220_8_ & 0xf0;
        double d = ((double)j + p_1220_1_.field_370_bf * 16D) / 256D;
        double d1 = (((double)j + p_1220_1_.field_364_bi * 16D) - 0.01D) / 256D;
        double d2 = ((double)(l + 16) - p_1220_1_.field_362_bj * 16D) / 256D;
        double d3 = ((double)(l + 16) - p_1220_1_.field_368_bg * 16D - 0.01D) / 256D;
        if(field_1774_c)
        {
            double d4 = d;
            d = d1;
        ...
        if(field_31087_g == 2)
        {
            d = ((double)j + p_1220_1_.field_368_bg * 16D) / 256D;
            d2 = ((double)(l + 16) - p_1220_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)j + p_1220_1_.field_362_bj * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1220_1_.field_364_bi * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31087_g == 1)
        {
            d = ((double)(j + 16) - p_1220_1_.field_362_bj * 16D) / 256D;
            d2 = ((double)l + p_1220_1_.field_364_bi * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1220_1_.field_368_bg * 16D) / 256D;
            d3 = ((double)l + p_1220_1_.field_370_bf * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31087_g == 3)
        {
            d = ((double)(j + 16) - p_1220_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1220_1_.field_364_bi * 16D - 0.01D) / 256D;
            d2 = ((double)l + p_1220_1_.field_362_bj * 16D) / 256D;
            d3 = (((double)l + p_1220_1_.field_368_bg * 16D) - 0.01D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
            ...
            int p_1225_8_)
    {
        ...
        if(Config.isConnectedTextures() && field_1771_b < 0)
        {
            int i = getConnectedTexture(p_1225_1_, (int)p_1225_2_, (int)p_1225_4_, (int)p_1225_6_, 3);
            if(i >= 0)
            {
                int k = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator = Tessellator.field_1512_a.getSubTessellator(k);
        ...
        int j = (p_1225_8_ & 0xf) << 4;
        int l = p_1225_8_ & 0xf0;
        double d = ((double)j + p_1225_1_.field_370_bf * 16D) / 256D;
        double d1 = (((double)j + p_1225_1_.field_364_bi * 16D) - 0.01D) / 256D;
        double d2 = ((double)(l + 16) - p_1225_1_.field_362_bj * 16D) / 256D;
        double d3 = ((double)(l + 16) - p_1225_1_.field_368_bg * 16D - 0.01D) / 256D;
        if(field_1774_c)
        {
            double d4 = d;
            d = d1;
        ...
        if(field_31086_h == 1)
        {
            d = ((double)j + p_1225_1_.field_368_bg * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1225_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)j + p_1225_1_.field_362_bj * 16D) / 256D;
            d2 = ((double)(l + 16) - p_1225_1_.field_364_bi * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31086_h == 2)
        {
            d = ((double)(j + 16) - p_1225_1_.field_362_bj * 16D) / 256D;
            d2 = ((double)l + p_1225_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1225_1_.field_368_bg * 16D) / 256D;
            d3 = ((double)l + p_1225_1_.field_364_bi * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31086_h == 3)
        {
            d = ((double)(j + 16) - p_1225_1_.field_370_bf * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1225_1_.field_364_bi * 16D - 0.01D) / 256D;
            d2 = ((double)l + p_1225_1_.field_362_bj * 16D) / 256D;
            d3 = (((double)l + p_1225_1_.field_368_bg * 16D) - 0.01D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
            ...
            int p_1231_8_)
    {
        ...
        if(Config.isConnectedTextures() && field_1771_b < 0)
        {
            int i = getConnectedTexture(p_1231_1_, (int)p_1231_2_, (int)p_1231_4_, (int)p_1231_6_, 4);
            if(i >= 0)
            {
                int k = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator = Tessellator.field_1512_a.getSubTessellator(k);
        ...
        int j = (p_1231_8_ & 0xf) << 4;
        int l = p_1231_8_ & 0xf0;
        double d = ((double)j + p_1231_1_.field_366_bh * 16D) / 256D;
        double d1 = (((double)j + p_1231_1_.field_360_bk * 16D) - 0.01D) / 256D;
        double d2 = ((double)(l + 16) - p_1231_1_.field_362_bj * 16D) / 256D;
        double d3 = ((double)(l + 16) - p_1231_1_.field_368_bg * 16D - 0.01D) / 256D;
        if(field_1774_c)
        {
            double d4 = d;
            d = d1;
        ...
        if(field_31084_j == 1)
        {
            d = ((double)j + p_1231_1_.field_368_bg * 16D) / 256D;
            d2 = ((double)(l + 16) - p_1231_1_.field_360_bk * 16D) / 256D;
            d1 = ((double)j + p_1231_1_.field_362_bj * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1231_1_.field_366_bh * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31084_j == 2)
        {
            d = ((double)(j + 16) - p_1231_1_.field_362_bj * 16D) / 256D;
            d2 = ((double)l + p_1231_1_.field_366_bh * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1231_1_.field_368_bg * 16D) / 256D;
            d3 = ((double)l + p_1231_1_.field_360_bk * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31084_j == 3)
        {
            d = ((double)(j + 16) - p_1231_1_.field_366_bh * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1231_1_.field_360_bk * 16D - 0.01D) / 256D;
            d2 = ((double)l + p_1231_1_.field_362_bj * 16D) / 256D;
            d3 = (((double)l + p_1231_1_.field_368_bg * 16D) - 0.01D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
            ...
            int p_1236_8_)
    {
        ...
        if(Config.isConnectedTextures() && field_1771_b < 0)
        {
            int i = getConnectedTexture(p_1236_1_, (int)p_1236_2_, (int)p_1236_4_, (int)p_1236_6_, 5);
            if(i >= 0)
            {
                int k = Config.getMinecraft().field_6315_n.func_1070_a("/ctm.png");
                tessellator = Tessellator.field_1512_a.getSubTessellator(k);
        ...
        int j = (p_1236_8_ & 0xf) << 4;
        int l = p_1236_8_ & 0xf0;
        double d = ((double)j + p_1236_1_.field_366_bh * 16D) / 256D;
        double d1 = (((double)j + p_1236_1_.field_360_bk * 16D) - 0.01D) / 256D;
        double d2 = ((double)(l + 16) - p_1236_1_.field_362_bj * 16D) / 256D;
        double d3 = ((double)(l + 16) - p_1236_1_.field_368_bg * 16D - 0.01D) / 256D;
        if(field_1774_c)
        {
            double d4 = d;
            d = d1;
        ...
        if(field_31085_i == 2)
        {
            d = ((double)j + p_1236_1_.field_368_bg * 16D) / 256D;
            d2 = ((double)(l + 16) - p_1236_1_.field_366_bh * 16D) / 256D;
            d1 = ((double)j + p_1236_1_.field_362_bj * 16D) / 256D;
            d3 = ((double)(l + 16) - p_1236_1_.field_360_bk * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31085_i == 1)
        {
            d = ((double)(j + 16) - p_1236_1_.field_362_bj * 16D) / 256D;
            d2 = ((double)l + p_1236_1_.field_360_bk * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1236_1_.field_368_bg * 16D) / 256D;
            d3 = ((double)l + p_1236_1_.field_366_bh * 16D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
        ...
        if(field_31085_i == 3)
        {
            d = ((double)(j + 16) - p_1236_1_.field_366_bh * 16D) / 256D;
            d1 = ((double)(j + 16) - p_1236_1_.field_360_bk * 16D - 0.01D) / 256D;
            d2 = ((double)l + p_1236_1_.field_362_bj * 16D) / 256D;
            d3 = (((double)l + p_1236_1_.field_368_bg * 16D) - 0.01D) / 256D;
            d5 = d1;
            d6 = d;
            d7 = d2;
            d8 = d3;
    ...
    private int getConnectedTexture(Block block, int i, int j, int k, int l)
    {
        if(field_1772_a == null)
        {
            return -1;
        }
        if(block == Block.field_382_N)
        {
            return getConnectedGlassTexture(block, i, j, k, l);
        }
        if(block == Block.field_407_ao)
        {
            return getConnectedBookShelfTexture(block, i, j, k, l);
        }
        if(block == Block.field_9264_Q)
        {
            ...
            {
                return getConnectedSandStoneTexture(block, i, j, k, l);
            }
        } else
        {
            return -1;
    ...
    private int getConnectedGlassTexture(Block block, int i, int j, int k, int l)
    {
        boolean aflag[] = new boolean[6];
        int i1 = Block.field_382_N.field_376_bc;
        switch(l)
        {
        case 0: // '\0'
        case 1: // '\001'
            aflag[0] = isNeighbour(field_1772_a, i - 1, j, k, i1);
            aflag[1] = isNeighbour(field_1772_a, i + 1, j, k, i1);
            aflag[2] = isNeighbour(field_1772_a, i, j, k + 1, i1);
            aflag[3] = isNeighbour(field_1772_a, i, j, k - 1, i1);
            break;

        case 2: // '\002'
            aflag[0] = isNeighbour(field_1772_a, i + 1, j, k, i1);
            aflag[1] = isNeighbour(field_1772_a, i - 1, j, k, i1);
            aflag[2] = isNeighbour(field_1772_a, i, j - 1, k, i1);
            aflag[3] = isNeighbour(field_1772_a, i, j + 1, k, i1);
            break;
        ...
        case 4: // '\004'
            aflag[0] = isNeighbour(field_1772_a, i, j, k - 1, i1);
            aflag[1] = isNeighbour(field_1772_a, i, j, k + 1, i1);
            aflag[2] = isNeighbour(field_1772_a, i, j - 1, k, i1);
            aflag[3] = isNeighbour(field_1772_a, i, j + 1, k, i1);
            break;
        ...
        case 0: // '\0'
        case 1: // '\001'
            aflag1[0] = !isNeighbour(field_1772_a, i + 1, j, k + 1, i1);
            aflag1[1] = !isNeighbour(field_1772_a, i - 1, j, k + 1, i1);
            aflag1[2] = !isNeighbour(field_1772_a, i + 1, j, k - 1, i1);
            aflag1[3] = !isNeighbour(field_1772_a, i - 1, j, k - 1, i1);
            break;

        case 2: // '\002'
            aflag1[0] = !isNeighbour(field_1772_a, i - 1, j - 1, k, i1);
            aflag1[1] = !isNeighbour(field_1772_a, i + 1, j - 1, k, i1);
            aflag1[2] = !isNeighbour(field_1772_a, i - 1, j + 1, k, i1);
            aflag1[3] = !isNeighbour(field_1772_a, i + 1, j + 1, k, i1);
            break;
        ...
        case 4: // '\004'
            aflag1[0] = !isNeighbour(field_1772_a, i, j - 1, k + 1, i1);
            aflag1[1] = !isNeighbour(field_1772_a, i, j - 1, k - 1, i1);
            aflag1[2] = !isNeighbour(field_1772_a, i, j + 1, k + 1, i1);
            aflag1[3] = !isNeighbour(field_1772_a, i, j + 1, k - 1, i1);
            break;
        ...
        if(byte0 == 17 && aflag1[0])
        {
            byte0 = 4;
        }
        if(byte0 == 19 && aflag1[1])
        {
            byte0 = 5;
        }
        if(byte0 == 49 && aflag1[2])
        {
            byte0 = 20;
        }
        if(byte0 == 51 && aflag1[3])
        {
            byte0 = 21;
        }
        if(byte0 == 18 && aflag1[0] && aflag1[1])
        {
            byte0 = 7;
        }
        if(byte0 == 33 && aflag1[0] && aflag1[2])
        {
            byte0 = 6;
        }
        if(byte0 == 35 && aflag1[3] && aflag1[1])
        {
            byte0 = 23;
        }
        if(byte0 == 50 && aflag1[3] && aflag1[2])
        {
            byte0 = 22;
        }
        if(byte0 == 18 && !aflag1[0] && aflag1[1])
        ...
        if(byte0 == 34 && aflag1[0] && aflag1[1] && aflag1[2] && aflag1[3])
        {
            byte0 = 58;
        }
        if(byte0 == 34 && !aflag1[0] && aflag1[1] && aflag1[2] && aflag1[3])
    ...
    private boolean isNeighbour(IBlockAccess iblockaccess, int i, int j, int k, int l)
    {
        return iblockaccess.func_600_a(i, j, k) == l;
    }

    private int getConnectedBookShelfTexture(Block block, int i, int j, int k, int l)
    {
        if(l == 0 || l == 1)
        {
            return 28;
        ...
        boolean flag = false;
        boolean flag1 = false;
        int i1 = Block.field_407_ao.field_376_bc;
        switch(l)
        {
        case 2: // '\002'
            flag = isNeighbour(field_1772_a, i + 1, j, k, i1);
            flag1 = isNeighbour(field_1772_a, i - 1, j, k, i1);
            break;
        ...
        case 4: // '\004'
            flag = isNeighbour(field_1772_a, i, j, k - 1, i1);
            flag1 = isNeighbour(field_1772_a, i, j, k + 1, i1);
            break;
        ...
        return !flag || flag1 ? 15 : 14;
    }

    private int getConnectedSandStoneTexture(Block block, int i, int j, int k, int l)
    {
        if(l == 0)
        {
            return 67;
        ...
        return !isNeighbour(field_1772_a, i, j + 1, k, Block.field_9264_Q.field_376_bc) ? 65 : 66;
    }
    ...
    public void func_1227_a(Block p_1227_1_, int p_1227_2_, float p_1227_3_)
    {
        ...
        if(Reflector.hasClass(0))
        {
            Reflector.callVoid(1, new Object[] {
                this, p_1227_1_, Integer.valueOf(p_1227_2_), Integer.valueOf(j)
            });
        }
    }
