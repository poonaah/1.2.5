...
public class Config
{
    ...
    private static final String version = "OptiFine_1.2.5_HD_A2";
    ...
    private static void checkOpenGlCaps()
    {
        ...
        log((new StringBuilder()).append("OpenGL: ").append(GL11.glGetString(7937)).append(" version ").append(GL11.glGetString(7938)).append(", ").append(GL11.glGetString(7936)).toString());
    ...
    public static void setGameSettings(GameSettings gamesettings)
    {
        ...
        minecraft = gameSettings.field_1563_u;
    }
    ...
    public static boolean isOcclusionEnabled()
    {
        ...
        {
            return gameSettings.field_27342_h;
        }
    }
    ...
    public static void log(String s)
    {
        ...
        try
        {
            if(logFile == null)
            {
                logFile = new File(Minecraft.func_6240_b(), "optifog.log");
                logFile.delete();
    ...
    public static boolean isRainFancy()
    {
        ...
        {
            return gameSettings.field_1576_i;
        } else
        {
...
;
    ...
    public static DisplayMode getDisplayMode(Dimension dimension)
