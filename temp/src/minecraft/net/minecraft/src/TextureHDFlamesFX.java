...
//            TextureFX, TextureHDFX, Block, BlockFire, 
//            Config, TexturePackBase

public class TextureHDFlamesFX extends TextureFX
    implements TextureHDFX
{
    ...
    public void func_783_a()
    {
        ...
        for(int i1 = 0; i1 < k; i1++)
        {
            ...
            int j3 = i1 * 4;
            field_1127_a[j3 + 0] = (byte)l1;
            field_1127_a[j3 + 1] = (byte)j2;
            field_1127_a[j3 + 2] = (byte)l2;
            field_1127_a[j3 + 3] = (byte)c;
        }
